...
<html lang='es'>
    ...
    <body>
        ...
        <div class="text-center"><h1>¡SE HA CANCELADO TU FACTURA CON EXITO!</h1><h2>Puedes seguir comprando y navegando en nuestra web </h2><h3>¿Que deseas seguir haciendo?</h3></div>
